...
class VendorProductVariantDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($query) {
            ...
            $veriantItems = "<a href='" . route('vendor.products-variant-item.index',['productId' => request()->product, 'variantId'=>$query->id], $query->id) . "' class='btn btn-info btn-space-right'><i class='far fa-edit'></i>Variant Items</a>";
