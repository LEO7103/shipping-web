...
class ProductVariantDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($query) {
            ...
            $veriantItems = "<a href='" . route('admin.products-variant-item.index',['productId' => request()->product, 'variantId'=>$query->id], $query->id) . "' class='btn btn-info mr-2'><i class='far fa-edit'></i>Variant Items</a>";
