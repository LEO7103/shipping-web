                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="inputState" class="form-control child-category"
                                                name="child_category" value="{{ old('status') }}">
                                                <option value="">Select</option>
                                            </select>
                                        </div>
                                    </div>
            ...
            $('body').on('change', '.main-category', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('.sub-category').html('<option value="">Selected</option>')
                        $.each(data, function(i, item) {
                            $('.sub-category').append(
                                `<option value="${item.id}">${item.name}</option>`)
                            //  $('.sub-category').append('<option value="'+item+'">Selected</option>')
                        })
                    },
            ...
            $('body').on('change', '.sub-category', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('.child-category').html('<option value="">Selected</option>')
                        $.each(data, function(i, item) {
