            ...
            <div class="row">
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            <td class="wsus__pro_name">
                                                ...
                                                @foreach ($item->options->variants as $key => $variant)
                                                    <span>{{ $key }}:
                                                        {{ $variant['name'] }}{{ $settings->currency_icon . $variant['price'] }}</span>
                                                @endforeach
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        ...
                        <p class="total"><span>total:</span> <span  id="cart_total">{{ $settings->currency_icon }}{{getMainCartToal()}}</span></p>

                        <form id="coupon_form">
                            <input type="text" placeholder="Coupon Code"  name="coupon_code"  value="{{session()->has('coupon') ?
                            session()->get('coupon')['coupon_code'] : ''}}">
                            <button type="submit" class="common_btn">apply</button>
                        </form>
                        <a class="common_btn mt-4 w-100 text-center" href="{{route('user.checkout')}}">checkout</a>
                        <a class="common_btn mt-1 w-100 text-center" href="{{route('home')}}"><i
                                class="fab fa-shopify"></i> Keep shipping</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.clear_cart').on('click', function(e) {
                ...
                Swal.fire({
                    title: "Are you sure?",
                    text: "This action will clear your Shop Cart!",
                    icon: "warning",
